    ...
    <section class="flex items-center hero">
        <div
            ...
            <h1 class="text-3xl md:text-5xl leading-tight font-semibold">
                We Are <br class="" />Geek Team
            </h1>
            <h2 class="px-8 text-base md:px-0 md:text-lg my-6 tracking-wide">
                Kami siap menjadi partner anda dalam melayani pengembangan teknologi informasi terkini
                <br class="hidden lg:block" />yang lebih efektif dan efisien serta berkomitmen dalam memberikan support
                system <br class="hidden lg:block" />terkait permasalahan IT.
            </h2>
            <div>
        ...
        <div class="w-full inset-0 md:relative md:w-1/2">
            <div class="relative hero-image">
                    ...
                    <button class="video hero-cta focus:outline-none z-30 modal-trigger" data-content='<div class="w-screen pb-56 md:w-88 md:pb-56 relative z-50">
                          <div class="absolute w-full h-full">
                            <iframe
                              width="100%"
                              height="100%"
                              src="https://www.youtube.com/embed/Ch7Pm6LYUaI"
                              frameborder="0"
                ...
                <img src="/frontend/images/content/image-section-1.jpg" alt="hero 1"
            ...
            <div class="grid grid-rows-2 grid-cols-9 gap-4">
                <div class="relative col-span-9 row-span-1 md:col-span-4 card" style="height: 180px">
                    ...
                    <div class="overlay left-0 top-0 bottom-0 flex justify-center flex-col pl-48 md:pl-72">
                        <h5 class="text-lg font-semibold">MOBILE APP DEVELOPMENT.</h5>
                        <span class="text-sm">Tidak dapat disangkal bahwa penggunaan internet seluler meningkat pesat.
                ...
                <div class="relative col-span-9 row-span-1 md:col-span-2 md:row-span-2 card">
                    ...
                    <div
                        ...
                        <h5 class="text-lg font-semibold">UI/UX DESIGN.</h5>
                        <span class="text-sm md:text-center">Ciptakan pengalaman pengguna terbaik untuk ukuran layar apa pun
                ...
                <div class="relative col-span-9 row-span-1 md:col-span-3 md:row-span-2 card">
                    ...
                    <div
                        class="overlay right-0 left-0 top-0 bottom-0 md:bottom-auto flex  justify-center md:items-center flex-col pl-48 md:pl-0 pt-0 md:pt-12">
                        <h5 class="text-lg font-semibold">ORIGINAL SOFTWARE.</h5>
                ...
                <div class="relative col-span-9 row-span-1 md:col-span-4 card">
                    ...
                    <div class="overlay left-0 top-0 bottom-0 flex justify-center flex-col pl-48 md:pl-72">
                        <h5 class="text-lg font-semibold">WEB DEVELOPMENT.</h5>
                        <span class="text-sm">Dengan pertumbuhan hampir 900% dari tahun 2000-2017, penggunaan internet sudah
